...
<body>
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="/index.php">Gasha Institute PMS<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
							...
							<li class="hvr-sweep-to-bottom">
								<a href="/Drives/mail.php">Mail Us<i>Get in Touch with us Instantly</i></a>
							</li>
	...
	<div class="e-page">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">403</h3>
			<h5 class="wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">Forbidden!</h5>
			<p class="wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">Please turn off your VPN, if not working still then please kindly <a href="../Drives/mail.php">Contact us </a>about the problem</p>
			<div class="see-button">
				<a class="btn btn-primary btn-lg see-button hvr-shutter-out-horizontal specialty-button e-button footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;" href="/index.php" role="button">Take Me Home</a>
			</div>
		</div>
		<!-- //container -->
	</div>
