...
<body>
	...
	<div class="e-page">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">401</h3>
			<h5 class="wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">Unauthorized!</h5>
			<p class="wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">Please check the URL, And Your Authentication. subsequently <a href="../Drives/mail.php">Contact us </a>for errors</p>
